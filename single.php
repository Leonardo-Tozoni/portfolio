...
<article class="t-article-v3 padding-bottom-lg">
  <div class="t-article-v3__hero margin-bottom-lg" style="background-image: url('<?= the_post_thumbnail_url( 'full' ); ?>')">
    <div class="container max-width-adaptive-sm">
      <div class="t-article-v3__intro-text text-component text-center">
        <h1 class="text-40 color-white">
					<?= get_the_title(); ?>
				</h1>
  ...
  <div class="container padding-y-lg border-top  max-width-adaptive-sm">
    <div class="author ">
